...
RSpec.describe "tecsgen command", type: :aruba do
  ...
  context "data_flat" do
    ...
    context "data_flat_1" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 4 do expect(last_command_started).to_not be_successfully_executed end
  ...
  context "data_abnormal" do
    ...
    context "data_abnormal_1" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 6 do expect(last_command_started).to_not be_successfully_executed end
    ...
    context "data_abnormal_2" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 8 do expect(last_command_started).to_not be_successfully_executed end
    ...
    context "data_abnormal_3" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 10 do expect(last_command_started).to_not be_successfully_executed end
    ...
    context "data_abnormal_4" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 12 do expect(last_command_started).to_not be_successfully_executed end
    ...
    context "data_abnormal_5" do
      ...
      it "execute successfully", test_normal_sh: true, tc: 14 do expect(last_command_started).to_not be_successfully_executed end
