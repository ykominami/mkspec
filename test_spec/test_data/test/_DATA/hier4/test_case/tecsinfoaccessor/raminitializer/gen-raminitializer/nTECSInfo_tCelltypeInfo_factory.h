...
#define tHelloWorld__sizeOfCB                              ((0))
#define tHelloWorld__sizeOfINIB                            ((sizeof(tHelloWorld_INIB)))
#define tHelloWorld__NCELLINLINKUNIT   (1)

#include "tTaskMain_tecsgen.h"
#define tTaskMain__IDX_is_ID_act                           (false)
#define tTaskMain__sizeOfCB                                ((0))
...
#define nTECSInfo_tCelltypeInfo__NCELLINLINKUNIT (6)
...
#define nTECSInfo_tCallInfo__NCELLINLINKUNIT (19)
...
#define nTECSInfo_tEntryInfo__NCELLINLINKUNIT (6)
...
#define nTECSInfo_tVarDeclInfo__NCELLINLINKUNIT (25)
...
#define nTECSInfo_tCellInfo__NCELLINLINKUNIT (6)
...
#define nTECSInfo_tRawEntryDescriptorInfo__NCELLINLINKUNIT (6)
...
#define nTECSInfo_tTECSInfoAccessor__IDX_is_ID_act         (false)
#define nTECSInfo_tTECSInfoAccessor__sizeOfCB              ((sizeof(nTECSInfo_tTECSInfoAccessor_CB)))
#define nTECSInfo_tTECSInfoAccessor__sizeOfINIB            ((sizeof(nTECSInfo_tTECSInfoAccessor_INIB)))
#define nTECSInfo_tTECSInfoAccessor__NCELLINLINKUNIT (1)
