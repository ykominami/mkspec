...
struct tag_nTECSInfo_sCellInfo_VDES * const rTEMP_rTECSInfo_rTEMPRegionInfo_cCellInfo[] = {
    &rTEMP_rTECSInfo_rTEMP_TaskCellInfo_eCellInfo_des,
    &rTEMP_rTECSInfo_rTEMP_TaskMainCellInfo_eCellInfo_des,
    &rTEMP_rTECSInfo_rTEMP_TECSInfoCompo_TECSInfoCellInfo_eCellInfo_des,
    &rTEMP_rTECSInfo_rTEMP_TECSInfoCompo_TECSInfoAccessorCellInfo_eCellInfo_des,
};
