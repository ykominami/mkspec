...
typedef struct tag_nTECSInfo_tSignatureInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sFunctionInfo_VDES *const*cFunctionInfo; /* TCP_2 */
    int_t n_cFunctionInfo;  /* TCP_3 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char*          name;
}  nTECSInfo_tSignatureInfo_CB;
/* singleton cell CB prototype declaration #_MCPB_# */
extern nTECSInfo_tSignatureInfo_CB  nTECSInfo_tSignatureInfo_CB_tab[];

/* celltype IDX type #_CTIX_# */
typedef struct tag_nTECSInfo_tSignatureInfo_CB *nTECSInfo_tSignatureInfo_IDX;
...
#define nTECSInfo_tSignatureInfo_N_CELL       (26)  /*  number of cells  #_NCEL_# */
