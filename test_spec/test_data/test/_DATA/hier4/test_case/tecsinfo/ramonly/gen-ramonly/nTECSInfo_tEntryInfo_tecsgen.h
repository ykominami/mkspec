...
typedef struct tag_nTECSInfo_tEntryInfo_CB {
    /* call port #_TCP_# */
...
#define nTECSInfo_tEntryInfo_N_CELL        (5)  /*  number of cells  #_NCEL_# */
