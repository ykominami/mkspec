...
typedef struct tag_nTECSInfo_tParamInfo_CB {
    /* call port #_TCP_# */
...
#define nTECSInfo_tParamInfo_N_CELL      (205)  /*  number of cells  #_NCEL_# */
