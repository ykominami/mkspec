...
typedef const struct tag_nTECSInfo_tTECSInfoSub_INIB {
    ...
    struct tag_nTECSInfo_sNamespaceInfo_VDES *cNamespaceInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sRegionInfo_VDES *cRegionInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sSignatureInfo_VDES *cSignatureInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sCelltypeInfo_VDES *cCelltypeInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sCellInfo_VDES *cCellInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sEntryInfo_VDES *cEntryInfoTemp_init_; /* TCP_2 */
    struct tag_nTECSInfo_sRawEntryDescriptorInfo_VDES *cRawEntryDescriptorInfoTemp_init_; /* TCP_2 */
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    int32_t        name_len;
    int32_t        path_len;
