...
typedef const struct tag_tCell3_INIB {
    /* call port #_TCP_# */
    ID const cCall3;  /* TCP_4 */
    ID const cCallB;  /* TCP_4 */
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    int32_t        a;
}  tCell3_INIB;
...
#define tCell3_CB_ptab           tCell3_INIB_ptab
#define tCell3_CB               tCell3_INIB
#define tag_tCell3_CB           tag_tCell3_INIB

/* singleton cell CB prototype declaration #_MCPP_# */
extern tCell3_INIB  *const tCell3_INIB_ptab[];
extern tCell3_INIB  comp1_comp12_cell3_INIB;
extern tCell3_INIB  comp2_comp12_cell3_INIB;
...
#define tCell3_ID_BASE              (5)  /* ID Base  #_NIDB_# */
...
#define tCell3_GET_CELLCB(idx) (tCell3_CB_ptab[(idx) - tCell3_ID_BASE])
