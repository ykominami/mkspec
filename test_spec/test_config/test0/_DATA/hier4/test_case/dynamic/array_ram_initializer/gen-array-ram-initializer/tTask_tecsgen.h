...
/* attr access  #_AAM_# */
#define tTask_ATTR_attribute( p_that )	((p_that)->_inib->attribute)
...
#define tTask_GET_attribute(p_that)	((p_that)->_inib->attribute)
...
#define ATTR_attribute       tTask_ATTR_attribute( p_cellcb )
