...
typedef struct tag_nTECSInfo_tIntTypeInfo_CB {
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char_t*        name;
    int8_t         typeKind;
...
#define nTECSInfo_tIntTypeInfo_N_CELL       (11)  /*  number of cells  #_NCEL_# */
