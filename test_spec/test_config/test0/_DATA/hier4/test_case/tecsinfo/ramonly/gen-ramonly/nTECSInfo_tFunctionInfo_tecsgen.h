...
typedef struct tag_nTECSInfo_tFunctionInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sParamInfo_VDES *const*cParamInfo; /* TCP_2 */
    int_t n_cParamInfo;  /* TCP_3 */
    struct tag_nTECSInfo_sTypeInfo_VDES const*cReturnTypeInfo; /* TCP_2 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char_t*        name;
    bool_t         bOneway;
}  nTECSInfo_tFunctionInfo_CB;
/* singleton cell CB prototype declaration #_MCPB_# */
extern nTECSInfo_tFunctionInfo_CB  nTECSInfo_tFunctionInfo_CB_tab[];

/* celltype IDX type #_CTIX_# */
typedef struct tag_nTECSInfo_tFunctionInfo_CB *nTECSInfo_tFunctionInfo_IDX;
...
#define nTECSInfo_tFunctionInfo_N_CELL      (170)  /*  number of cells  #_NCEL_# */
