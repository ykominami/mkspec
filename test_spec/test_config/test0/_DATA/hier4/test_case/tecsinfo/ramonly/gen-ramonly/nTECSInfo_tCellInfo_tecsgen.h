...
typedef struct tag_nTECSInfo_tCellInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sCelltypeInfo_VDES const*cCelltypeInfo; /* TCP_2 */
    struct tag_nTECSInfo_sRawEntryDescriptorInfo_VDES *const*cRawEntryDescriptor; /* TCP_2 */
    int_t n_cRawEntryDescriptor;  /* TCP_3 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char_t*        name;
    void*          cbp;
    void*          inibp;
}  nTECSInfo_tCellInfo_CB;
/* singleton cell CB prototype declaration #_MCPB_# */
extern nTECSInfo_tCellInfo_CB  nTECSInfo_tCellInfo_CB_tab[];

/* celltype IDX type #_CTIX_# */
typedef struct tag_nTECSInfo_tCellInfo_CB *nTECSInfo_tCellInfo_IDX;
...
#define nTECSInfo_tCellInfo_N_CELL        (5)  /*  number of cells  #_NCEL_# */
