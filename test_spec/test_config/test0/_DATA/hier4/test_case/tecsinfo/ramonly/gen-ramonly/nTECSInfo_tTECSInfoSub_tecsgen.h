...
typedef struct tag_nTECSInfo_tTECSInfoSub_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sNamespaceInfo_VDES const*cNamespaceInfo; /* TCP_2 */
    struct tag_nTECSInfo_sRegionInfo_VDES const*cRegionInfo; /* TCP_2 */
    struct tag_nTECSInfo_sNamespaceInfo_VDES *cNamespaceInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sRegionInfo_VDES *cRegionInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sSignatureInfo_VDES *cSignatureInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sCelltypeInfo_VDES *cCelltypeInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sCellInfo_VDES *cCellInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sEntryInfo_VDES *cEntryInfoTemp; /* TCP_2 */
    struct tag_nTECSInfo_sRawEntryDescriptorInfo_VDES *cRawEntryDescriptorInfoTemp; /* TCP_2 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    int32_t        name_len;
    int32_t        path_len;
...
/* attr access  #_AAM_# */
#define nTECSInfo_tTECSInfoSub_ATTR_name_len	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.name_len)
#define nTECSInfo_tTECSInfoSub_ATTR_path_len	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.path_len)

#define nTECSInfo_tTECSInfoSub_GET_name_len()	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.name_len)
#define nTECSInfo_tTECSInfoSub_GET_path_len()	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.path_len)


/* var access macro #_VAM_# */
#define nTECSInfo_tTECSInfoSub_VAR_name1	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.name1)
#define nTECSInfo_tTECSInfoSub_VAR_name2	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.name2)
#define nTECSInfo_tTECSInfoSub_VAR_path	(nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.path)
...
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getName( name, max_len ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getName__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo, (name), (max_len) )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getNameLength( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getNameLength__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getNNamespace( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getNNamespace__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getNamespaceInfo( ith, des ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getNamespaceInfo__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo, (ith), (des) )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getNSignature( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getNSignature__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getSignatureInfo( ith, des ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getSignatureInfo__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo, (ith), (des) )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getNCelltype( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getNCelltype__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo )
#define nTECSInfo_tTECSInfoSub_cNamespaceInfo_getCelltypeInfo( ith, des ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo->VMT->getCelltypeInfo__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo, (ith), (des) )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getName( name, max_len ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getName__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo, (name), (max_len) )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getNameLength( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getNameLength__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getNCell( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getNCell__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getCellInfo( ith, des ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getCellInfo__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo, (ith), (des) )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getNRegion( ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getNRegion__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo )
#define nTECSInfo_tTECSInfoSub_cRegionInfo_getRegionInfo( ith, des ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo->VMT->getRegionInfo__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo, (ith), (des) )
...
nTECSInfo_tTECSInfoSub_cNamespaceInfo_refer_to_descriptor(  )
{
    ...
    des.vdes = (struct tag_nTECSInfo_sNamespaceInfo_VDES *)nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cNamespaceInfo;
    return des;
}
...
nTECSInfo_tTECSInfoSub_cRegionInfo_refer_to_descriptor(  )
{
    ...
    /* cast is ncecessary for removing 'const'  */
    des.vdes = (struct tag_nTECSInfo_sRegionInfo_VDES *)nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRegionInfo;
    return des;
}
