...
typedef struct tag_nTECSInfo_tRegionInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sCellInfo_VDES *const*cCellInfo; /* TCP_2 */
    int_t n_cCellInfo;  /* TCP_3 */
    struct tag_nTECSInfo_sRegionInfo_VDES *const*cRegionInfo; /* TCP_2 */
    int_t n_cRegionInfo;  /* TCP_3 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char*          name;
}  nTECSInfo_tRegionInfo_CB;
/* singleton cell CB prototype declaration #_MCPB_# */
extern nTECSInfo_tRegionInfo_CB  nTECSInfo_tRegionInfo_CB_tab[];

/* celltype IDX type #_CTIX_# */
typedef struct tag_nTECSInfo_tRegionInfo_CB *nTECSInfo_tRegionInfo_IDX;
