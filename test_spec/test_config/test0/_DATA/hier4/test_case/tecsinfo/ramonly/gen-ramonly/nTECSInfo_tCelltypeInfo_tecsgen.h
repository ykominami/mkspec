...
typedef struct tag_nTECSInfo_tCelltypeInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sEntryInfo_VDES *const*cEntryInfo; /* TCP_2 */
    int_t n_cEntryInfo;  /* TCP_3 */
    struct tag_nTECSInfo_sCallInfo_VDES *const*cCallInfo; /* TCP_2 */
    int_t n_cCallInfo;  /* TCP_3 */
    struct tag_nTECSInfo_sVarDeclInfo_VDES *const*cAttrInfo; /* TCP_2 */
    int_t n_cAttrInfo;  /* TCP_3 */
    struct tag_nTECSInfo_sVarDeclInfo_VDES *const*cVarInfo; /* TCP_2 */
    int_t n_cVarInfo;  /* TCP_3 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char_t*        name;
    bool_t         b_singleton;
...
#define nTECSInfo_tCelltypeInfo_N_CELL        (5)  /*  number of cells  #_NCEL_# */
