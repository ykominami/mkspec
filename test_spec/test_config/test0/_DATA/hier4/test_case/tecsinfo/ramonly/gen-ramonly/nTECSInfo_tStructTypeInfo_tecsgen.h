...
typedef struct tag_nTECSInfo_tStructTypeInfo_CB {
    /* call port #_TCP_# */
    struct tag_nTECSInfo_sVarDeclInfo_VDES *const*cVarDeclInfo; /* TCP_2 */
    int_t n_cVarDeclInfo;  /* TCP_3 */
    /* call port #_NEP_# */ 
    /* attribute #_AT_# */ 
    char_t*        name;
    int8_t         typeKind;
...
#define nTECSInfo_tStructTypeInfo_N_CELL        (3)  /*  number of cells  #_NCEL_# */
...
#define nTECSInfo_tStructTypeInfo_is_cVarDeclInfo_joined(p_that,subscript) \
	  (((p_that)->cVarDeclInfo!=0)\
	  &&((p_that)->cVarDeclInfo[subscript]!=0))
...
#define is_cVarDeclInfo_joined(subscript)\
		nTECSInfo_tStructTypeInfo_is_cVarDeclInfo_joined(p_cellcb,subscript)
